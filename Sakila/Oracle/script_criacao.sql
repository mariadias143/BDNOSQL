...
CREATE TABLE inventory (
  inventory_id SMALLINT GENERATED BY DEFAULT AS IDENTITY (START WITH 1 INCREMENT BY 1),
  film_id INT NOT NULL,
  store_id INT NOT NULL,
  last_update DATE NOT NULL,
...
CREATE TABLE rental (
  rental_id SMALLINT GENERATED BY DEFAULT AS IDENTITY (START WITH 1 INCREMENT BY 1),
